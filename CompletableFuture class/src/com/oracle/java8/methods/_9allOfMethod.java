    ...
    public static void main(String[] args) throws ExecutionException, InterruptedException {
        ...
        CompletableFuture<List<String>> allPageContentsFuture = allFutures.thenApply(v -> {
            ...
            /*
                ...
                get() is declared in Future interface as :
                V get() throws InterruptedException, ExecutionException;
                The exceptions are both checked exceptions which means
                they need to be handled in your code.

                The join() method doesn't throw checked exceptions.
                Instead it throws unchecked CompletionException.
                So you do not need a try-catch block and instead
                you can fully harness exceptionally() method
             */
